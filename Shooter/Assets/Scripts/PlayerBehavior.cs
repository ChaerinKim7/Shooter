...
public class PlayerBehavior : MonoBehaviour
{
    ...
    public float verticalScreenLimit_1;
    public float verticalScreenLimit_2;
    ...
    void Start()
    {
        ...
        verticalScreenLimit_1 = 0f;
        verticalScreenLimit_2 = 3.5f;
    ...
    void Movement()
    {
        ...
        if (transform.position.y > verticalScreenLimit_1)
        {
            //transform.position = new Vector3(transform.position.x, -verticalScreenLimit, 0);
            transform.position = new Vector3(transform.position.x, verticalScreenLimit_1, 0);
        }
        else if (transform.position.y < -verticalScreenLimit_2)
        {
            transform.position = new Vector3(transform.position.x, -verticalScreenLimit_2, 0);
        }
    }
